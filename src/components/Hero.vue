      ...
      <div class="flex flex-col sm:flex-row">
        <div class="sm:p-8 p-8 mt-4 pt-4 sm:mt-0">
          <div class="flex flex-col gap-2">
            <p class="text-lg font-medium text-white">Hi, My Name is</p>
            <p class="text-5xl font-semibold text-white">
              Fernando Jose A. Lopez
            </p>
            <p class="text-base font-normal text-gray-200 mt-2">
              CLSU BSIT graduate with a focus on system development. Skilled in
              front-end and back-end web development. Proficient in creating
              user-friendly and dynamic web applications using various
